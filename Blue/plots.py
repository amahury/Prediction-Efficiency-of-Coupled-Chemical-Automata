...
lambda005 = pd.read_excel("results_lambda=0.05_blue.xlsx") 
lambda05 = pd.read_excel("results_lambda=0.5_blue.xlsx") 
lambda1 = pd.read_excel("results_lambda=1_blue.xlsx")
lambda15 = pd.read_excel("results_lambda=1.5_blue.xlsx")
