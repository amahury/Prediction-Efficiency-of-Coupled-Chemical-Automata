...
class Reservoir(): #=========================================================================#
    ...
    def initialize_reservoir(self, num_reservoir_nodes = 5, w_in_sparsity = 0, w_in_strength = 0.05, num_input_nodes = 1, num_output_nodes = 1):
        # Set parameters
    ...
    def summarize_stat(self):
        ...
        self.result_summary_df = pd.DataFrame(result_summary.reshape(1,22))
        self.result_summary_df = self.result_summary_df.rename(columns = {0:"network",
                                                          ...
                                                          7:"epsilon", 8:"q", 9:"gamma",                                                               10:"f", 11:"alfa", 12:"beta",
                                                          13:"num_nodes", 14:"Win_strength",
                                                          15:"Win_sparsity", 16:"data_size",
                                                          17:"test_fraction", 18:"washout_data",
                                                          19:"training_time", 20:"learnmodel_time", 21:"testing_time"})
#=========================================================================#
