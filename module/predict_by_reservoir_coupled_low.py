...
class Reservoir(): #=========================================================================#
    ...
    def initialize_reservoir(self, num_reservoir_nodes = 10, w_in_sparsity = 0, w_in_strength = 0.05, num_input_nodes = 1, num_output_nodes = 1):
        # Set parameters
    ...
    def compute_reservoir_state(self, epsilon = 0.0667, q = 0.0008, gamma = 0.0000889, f = 0.65, alfa = 270, beta = 430, betap = 412.8, kappa = 0.00002475,
                                initial_state = [0.0, 3.287, 0.006225, 0.4, 0.4, 0, 24.26, 0.04515, 0.4, 0.404]):
        ...
        for data_i, input_train in enumerate(self.train_data):
            ...
            z1 = 0.001*(a0 * x0 - b0 * z0 + self.kappa * np.log( abs( (1-z0)*z0p/(z0*(1-z0p)) )) )
            ...
            z2 = 0.001*(a0p * x0p - b0p * z0p - self.kappa * np.log( abs( (1-z0)*z0p/(z0*(1-z0p)) )) )
    ...
    def summarize_stat(self):
        ...
        result_summary = np.array([self.network, round(self.train_pred, 4), round(self.test_pred, 4),
                                 ...
                                 round(self.epsilon, 3), round(self.q, 3), round(self.gamma, 3), round(self.f, 3), 
                                 round(self.alfa, 3), round(self.beta, 3), round(self.betap, 3), round(self.kappa, 3),
        ...
        self.result_summary_df = pd.DataFrame(result_summary.reshape(1,24))
        self.result_summary_df = self.result_summary_df.rename(columns = {0:"network",
                                                          ...
                                                          7:"epsilon", 8:"q", 9:"gamma",                                                                                                               10:"f", 11:"alfa", 12:"beta", 13:"betap", 14:"kappa",
                                                          15:"num_nodes", 16:"Win_strength",
                                                          17:"Win_sparsity", 18:"data_size",
                                                          19:"test_fraction", 20:"washout_data",
                                                          21:"training_time", 22:"learnmodel_time", 23:"testing_time"})
#=========================================================================#
