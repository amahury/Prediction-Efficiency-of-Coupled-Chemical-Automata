...
lambda005 = pd.read_excel("results_lambda=0.05_violet.xlsx") 
lambda05 = pd.read_excel("results_lambda=0.5_violet.xlsx") 
lambda1 = pd.read_excel("results_lambda=1_violet.xlsx")
lambda15 = pd.read_excel("results_lambda=1.5_violet.xlsx")
