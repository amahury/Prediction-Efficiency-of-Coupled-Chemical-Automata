...
lambda005 = pd.read_excel("results_lambda=0.05_brown.xlsx") 
lambda05 = pd.read_excel("results_lambda=0.5_brown.xlsx") 
lambda1 = pd.read_excel("results_lambda=1_brown.xlsx")
lambda15 = pd.read_excel("results_lambda=1.5_brown.xlsx")
